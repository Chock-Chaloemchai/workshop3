...
# https method [get, put, patch, delete]
# command detabase [find, insert, update, update, delete]


@app.get("/")
def index():
    return JSONResponse(
        content={"message": "Hello,  World user Chock"}, status_code=200
    )
...
# url http://localhost:3001/example/?start=10&limit=9


@app.get("/profiles/{name}/{age}")
...
# url http://localhost:3001/profiles/chock/21
